          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <span className="text-luxury-gold font-black tracking-[0.2em] uppercase text-[10px] mb-6 block border-l-2 border-luxury-gold pl-4">
                ABOUT Touch and Magic - UNISEX FAMILY SALON IN Downtown Area
              </span>
              ...
              <p className="text-gray-500 text-xl mb-12 leading-relaxed font-medium">
                At <span className="text-black font-black">Touch and Magic</span>, we don't do guesswork. As a unisex family salon in Downtown Area, we combine strong fundamentals with modern styling—so every cut sits better, every colour looks balanced, and every treatment is chosen for your hair's actual condition.
              </p>
